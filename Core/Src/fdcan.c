...
void MX_FDCAN1_Init(void)
{
  ...
  hfdcan1.Init.ExtFiltersNbr = 0x000;
...
void MX_FDCAN2_Init(void)
{
  ...
  hfdcan2.Init.StdFiltersNbr = 0x000;
  hfdcan2.Init.ExtFiltersNbr = 0x000;
...
void MX_FDCAN3_Init(void)
{
  ...
  hfdcan3.Init.NominalTimeSeg1 = 42;
  hfdcan3.Init.NominalTimeSeg2 = 2;
  hfdcan3.Init.DataPrescaler = 5;
  hfdcan3.Init.DataSyncJumpWidth = 1;
  hfdcan3.Init.DataTimeSeg1 = 25;
  hfdcan3.Init.DataTimeSeg2 = 1;
  hfdcan3.Init.MessageRAMOffset = 1920;
  hfdcan3.Init.StdFiltersNbr = 0x000;
  hfdcan3.Init.ExtFiltersNbr = 0x000;
